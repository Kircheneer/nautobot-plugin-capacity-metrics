...
# Variables may be overwritten in invoke.yml or by the environment variables INVOKE_NAUTOBOT_CAPACITY_METRICS_xxx
...
def makemigrations(context, name=""):
    ...
    command = "nautobot-server makemigrations nautobot_capacity_metrics"
...
def unittest(context, keepdb=False, label="nautobot_capacity_metrics", failfast=False, buffer=True):
